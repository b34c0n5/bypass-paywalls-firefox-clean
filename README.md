...
Or switch to [Kiwi browser (Chromium)](https://play.google.com/store/apps/details?id=com.kiwibrowser.browser) or use the [adblocker filter/userscripts](https://gitflic.ru/project/magnolia1234/bypass-paywalls-clean-filters) (much less supported sites).

#### Chrome/Chromium
Visit the [Chrome repository on GitHub](https://github.com/bpc-clone/bypass-paywalls-chrome-clean) of Bypass Paywalls Clean.\
